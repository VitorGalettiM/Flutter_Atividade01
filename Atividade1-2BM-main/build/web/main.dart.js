...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var conta_list = Object.create(dart.library);
  var conta_service = Object.create(dart.library);
  var conta_form = Object.create(dart.library);
  ...
  var T = {
    ...
    BuildContextToTelaFormularioConta: () => (T.BuildContextToTelaFormularioConta = dart.constFn(dart.fnType(conta_form.TelaFormularioConta, [framework.BuildContext])))(),
  ...
  var I = [
    ...
    "file:///zapp/project/lib/screens/conta_list.dart",
    "file:///zapp/project/lib/services/conta_service.dart",
    "file:///zapp/project/lib/screens/conta_form.dart",
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    build(context) {
      return new app.MaterialApp.new({title: "Aplicação Bancária", theme: theme_data.ThemeData.new({primarySwatch: colors.Colors.blue}), home: new conta_list.TelaListaContas.new()});
    }
  ...
  conta_list.TelaListaContas = class TelaListaContas extends framework.StatefulWidget {
    createState() {
      return new conta_list._TelaListaContasState.new();
    }
    static ['_#new#tearOff']() {
      return new conta_list.TelaListaContas.new();
    }
  };
  (conta_list.TelaListaContas.new = function() {
    conta_list.TelaListaContas.__proto__.new.call(this);
    ;
  }).prototype = conta_list.TelaListaContas.prototype;
  dart.addTypeTests(conta_list.TelaListaContas);
  dart.addTypeCaches(conta_list.TelaListaContas);
  dart.setMethodSignature(conta_list.TelaListaContas, () => ({
    __proto__: dart.getMethods(conta_list.TelaListaContas.__proto__),
    createState: dart.fnType(conta_list._TelaListaContasState, [])
  }));
  dart.setLibraryUri(conta_list.TelaListaContas, I[1]);
  conta_list._TelaListaContasState = class _TelaListaContasState extends framework.State$(conta_list.TelaListaContas) {
    initState() {
      super.initState();
      this.carregarContas();
    }
    carregarContas() {
      return async.async(dart.void, (function* carregarContas() {
        let dados = (yield conta_service.ContaService.getContas());
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Lista de Contas")}), body: new scroll_view.ListView.builder({itemCount: this.contas[$length], itemBuilder: dart.fn((context, index) => new list_tile.ListTile.new({title: new text.Text.new(core.String.as(dart.dsend(this.contas[$_get](index), '_get', ["nome"]))), subtitle: new text.Text.new("Saldo: R$ " + dart.str(dart.dsend(this.contas[$_get](index), '_get', ["saldo"])))}), T.BuildContextAndintToListTile())}), floatingActionButton: new floating_action_button.FloatingActionButton.new({child: new icon.Icon.new(icons.Icons.add), onPressed: dart.fn(() => async.async(dart.void, (function*() {
            let resultado = (yield navigator.Navigator.push(dart.dynamic, context, new page.MaterialPageRoute.new({builder: dart.fn(context => new conta_form.TelaFormularioConta.new(), T.BuildContextToTelaFormularioConta())})));
            if (dart.equals(resultado, true)) {
              this.carregarContas();
            }
  ...
  (conta_list._TelaListaContasState.new = function() {
    this.contas = [];
    conta_list._TelaListaContasState.__proto__.new.call(this);
    ;
  }).prototype = conta_list._TelaListaContasState.prototype;
  dart.addTypeTests(conta_list._TelaListaContasState);
  dart.addTypeCaches(conta_list._TelaListaContasState);
  dart.setMethodSignature(conta_list._TelaListaContasState, () => ({
    __proto__: dart.getMethods(conta_list._TelaListaContasState.__proto__),
    carregarContas: dart.fnType(async.Future$(dart.void), []),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(conta_list._TelaListaContasState, I[1]);
  dart.setFieldSignature(conta_list._TelaListaContasState, () => ({
    __proto__: dart.getFields(conta_list._TelaListaContasState.__proto__),
    contas: dart.fieldType(core.List)
  }));
  conta_service.ContaService = class ContaService extends core.Object {
    static getContas() {
      return async.async(core.List, function* getContas() {
        let response = (yield http.get(core.Uri.parse("http://localhost:3000/contas")));
        if (response.statusCode === 200) {
          return T.FutureOrOfList().as(convert.json.decode(response.body));
        } else {
          dart.throw(core.Exception.new("Erro ao carregar contas"));
        }
      });
    }
    static criarConta(nome, saldo) {
      return async.async(dart.void, function* criarConta() {
        let body = convert.json.encode(new (T.IdentityMapOfString$Object()).from(["nome", nome, "saldo", saldo]));
        let response = (yield http.post(core.Uri.parse("http://localhost:3000/contas"), {headers: new (T.IdentityMapOfString$String()).from(["Content-Type", "application/json"]), body: body}));
        if (response.statusCode !== 201) {
          dart.throw(core.Exception.new("Erro ao criar conta"));
        }
      });
    }
    static ['_#new#tearOff']() {
      return new conta_service.ContaService.new();
    }
  };
  (conta_service.ContaService.new = function() {
    ;
  }).prototype = conta_service.ContaService.prototype;
  dart.addTypeTests(conta_service.ContaService);
  dart.addTypeCaches(conta_service.ContaService);
  dart.setStaticMethodSignature(conta_service.ContaService, () => ['getContas', 'criarConta']);
  dart.setLibraryUri(conta_service.ContaService, I[2]);
  dart.setStaticFieldSignature(conta_service.ContaService, () => ['_url']);
  dart.defineLazy(conta_service.ContaService, {
    /*conta_service.ContaService._url*/get _url() {
      return "http://localhost:3000/contas";
    }
  }, false);
  conta_form.TelaFormularioConta = class TelaFormularioConta extends framework.StatefulWidget {
    createState() {
      return new conta_form._TelaFormularioContaState.new();
    }
    static ['_#new#tearOff']() {
      return new conta_form.TelaFormularioConta.new();
    }
  };
  (conta_form.TelaFormularioConta.new = function() {
    conta_form.TelaFormularioConta.__proto__.new.call(this);
    ;
  }).prototype = conta_form.TelaFormularioConta.prototype;
  dart.addTypeTests(conta_form.TelaFormularioConta);
  dart.addTypeCaches(conta_form.TelaFormularioConta);
  dart.setMethodSignature(conta_form.TelaFormularioConta, () => ({
    __proto__: dart.getMethods(conta_form.TelaFormularioConta.__proto__),
    createState: dart.fnType(conta_form._TelaFormularioContaState, [])
  }));
  dart.setLibraryUri(conta_form.TelaFormularioConta, I[3]);
  var _formKey = dart.privateName(conta_form, "_formKey");
  var EdgeInsets_bottom = dart.privateName(edge_insets, "EdgeInsets.bottom");
  var EdgeInsets_right = dart.privateName(edge_insets, "EdgeInsets.right");
  var EdgeInsets_top = dart.privateName(edge_insets, "EdgeInsets.top");
  var EdgeInsets_left = dart.privateName(edge_insets, "EdgeInsets.left");
  conta_form._TelaFormularioContaState = class _TelaFormularioContaState extends framework.State$(conta_form.TelaFormularioConta) {
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Criar Conta")}), body: new basic.Padding.new({padding: C[1] || CT.C1, child: new form.Form.new({key: this[_formKey], child: new basic.Column.new({children: T.JSArrayOfWidget().of([new text_form_field.TextFormField.new({decoration: new input_decorator.InputDecoration.new({labelText: "Nome"}), onChanged: dart.fn(value => {
                    this.nome = value;
                  }, T.StringTovoid())}), new text_form_field.TextFormField.new({decoration: new input_decorator.InputDecoration.new({labelText: "Saldo"}), keyboardType: text_input.TextInputType.number, onChanged: dart.fn(value => {
                    this.saldo = core.double.parse(value);
                  }, T.StringTovoid())}), new basic.SizedBox.new({height: 20}), new elevated_button.ElevatedButton.new({onPressed: dart.fn(() => async.async(dart.void, (function*() {
                    if (dart.nullCheck(this[_formKey].currentState).validate()) {
                      yield conta_service.ContaService.criarConta(this.nome, this.saldo);
                      navigator.Navigator.pop(core.bool, context, true);
                    }
                  }).bind(this)), T.VoidToFutureOfvoid()), child: new text.Text.new("Salvar")})])})})})});
    }
    static ['_#new#tearOff']() {
      return new conta_form._TelaFormularioContaState.new();
    }
  };
  (conta_form._TelaFormularioContaState.new = function() {
    this[_formKey] = T.GlobalKeyOfFormState().new();
    this.nome = "";
    this.saldo = 0;
    conta_form._TelaFormularioContaState.__proto__.new.call(this);
    ;
  }).prototype = conta_form._TelaFormularioContaState.prototype;
  dart.addTypeTests(conta_form._TelaFormularioContaState);
  dart.addTypeCaches(conta_form._TelaFormularioContaState);
  dart.setMethodSignature(conta_form._TelaFormularioContaState, () => ({
    __proto__: dart.getMethods(conta_form._TelaFormularioContaState.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(conta_form._TelaFormularioContaState, I[3]);
  dart.setFieldSignature(conta_form._TelaFormularioContaState, () => ({
    __proto__: dart.getFields(conta_form._TelaFormularioContaState.__proto__),
    [_formKey]: dart.finalFieldType(framework.GlobalKey$(form.FormState)),
    nome: dart.fieldType(core.String),
    saldo: dart.fieldType(core.double)
  }));
  ...
  dart.trackLibraries("zapp_user_main", {
    ...
    "file:///zapp/project/lib/screens/conta_list.dart": conta_list,
    "file:///zapp/project/lib/services/conta_service.dart": conta_service,
    "file:///zapp/project/lib/screens/conta_form.dart": conta_form,
